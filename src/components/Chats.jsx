...
const Chats = () => {
  ...
  const { users, setUsers,chats, setChats,selectedChat,setSelectedChat,resetFooterStates,data} = useChatContext();
  ...
  return (
    ...
    <div className="chat-container">
      ...
      <RiSearch2Line style={{ position: 'absolute', top: '24px', left: '25px' }} />
        ...
        return (
          ...
          >
            ...
            <div className="userChatInfo">
              ...
              {!!unreadMsgs?.[chat[0]]?.length && <span className="alert">{unreadMsgs?.[chat[0]]?.length}</span>}
            </div>
          </div>
        )
